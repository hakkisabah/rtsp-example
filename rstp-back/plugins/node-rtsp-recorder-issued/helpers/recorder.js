...
const RTSPRecorder = class {
  ...
  // copy from : https://github.com/sahilchaddha/node-rtsp-recorder/issues/9#issuecomment-587714516
  getChildProcess(fileName) {
    let args = ["ffmpeg", "-rtsp_transport", "tcp", "-i", this.url];
